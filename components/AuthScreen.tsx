        ...
        <div className="bg-base rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.1)] border border-gray-100 p-8 relative overflow-hidden">
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              <button
                type="button"
                className="flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 font-medium text-gray-700 hover:border-gray-400"
              >
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.96-3.24-1.44-1.84-.78-2.93-1.18-4.48-2.03-2.21-1.2-3.83-2.7-4.93-4.82-1.15-2.27-.64-5.05 1.17-6.8.9-.9 1.96-1.44 3.13-1.44 1.23 0 2.08.36 2.93.81.72.36 1.44.73 2.57 1.29.18.09.27.13.37.13.14 0 .28-.06.38-.13.18-.09.36-.19.54-.28.73-.36 1.45-.73 2.17-1.09.85-.45 1.7-.81 2.93-.81 1.17 0 2.23.54 3.13 1.44.9.9 1.44 1.96 1.44 3.13 0 1.23-.36 2.08-.81 2.93-.36.73-.73 1.45-1.09 2.17-.09.18-.19.36-.28.54-.07.1-.13.24-.13.38 0 .1.04.19.13.37.56 1.13.93 1.85 1.29 2.57.45.85.81 1.7.81 2.93 0 1.17-.54 2.23-1.44 3.13z" />
                </svg>
                Apple
              </button>
            </motion.div>
