...
export default function BestSellerPage() {
  ...
  const loadProducts = useCallback(async () => {
    try {
      setIsLoading(true)
      const fetchedProducts = await fetchProductsFromSupabase('best-seller')
  ...
  // Realtime updates for products/images
  useEffect(() => {
  ...
  const handleToggleStock = () => {
    // This will be handled by ProductKebabMenu via Supabase
    router.refresh()
  }
      ...
      <div className="border-b border-gray-200 bg-base sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 uppercase tracking-tight">BEST SELLER</h1>
